          ...
          return (
            <tbody key={f.id}>
              <tr
                ...
                className={`cursor-pointer border-b border-border/50 transition-colors hover:bg-muted/50 ${onRwy27 ? 'bg-amber-50/70 dark:bg-amber-950/30' : isApproaching ? 'bg-emerald-50/50 dark:bg-emerald-950/30' : ''} ${selectedFlightId === f.id ? 'border-l-2 border-l-orange-500' : ''}`}
              >
